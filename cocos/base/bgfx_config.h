...
//cjh FIXME: how to define the max count of render buffers.
#ifndef BGFX_CONFIG_MAX_RENDER_BUFFERS
#    define BGFX_CONFIG_MAX_RENDER_BUFFERS 128
#endif // BGFX_CONFIG_MAX_RENDER_BUFFERS
