...
SE_DECLARE_FUNC(js_pipeline_PipelineSceneData_getSphere);
...
SE_DECLARE_FUNC(js_pipeline_RenderPipeline_getPipelineSceneData);
...
extern se::Object *__jsb_cc_pipeline_GbufferFlow_proto; // NOLINT
extern se::Class * __jsb_cc_pipeline_GbufferFlow_class; // NOLINT

bool js_register_cc_pipeline_GbufferFlow(se::Object *obj); // NOLINT
bool register_all_pipeline(se::Object *obj);                   // NOLINT
