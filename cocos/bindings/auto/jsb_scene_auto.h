...
SE_DECLARE_FUNC(js_scene_Node__getChild);
SE_DECLARE_FUNC(js_scene_Node__getChildrenSize);
SE_DECLARE_FUNC(js_scene_Node__setChild);
SE_DECLARE_FUNC(js_scene_Node__setChildren);
SE_DECLARE_FUNC(js_scene_Node__setChildrenSize);
...
SE_DECLARE_FUNC(js_scene_Node_setLayerForJS);
...
template <>
bool sevalue_to_native(const se::Value &, cc::scene::InstancedAttributeBlock *, se::Object *ctx);
...
SE_DECLARE_FUNC(js_scene_Model__setInstancedAttributesViewData);
...
SE_DECLARE_FUNC(js_scene_Camera_screenPointToRay);
...
template <>
bool sevalue_to_native(const se::Value &, cc::scene::PassDynamicsValue *, se::Object *ctx);
...
SE_DECLARE_FUNC(js_scene_Pass__setRootBufferDirty);
...
template <>
bool sevalue_to_native(const se::Value &, cc::IMaterialInstanceInfo *, se::Object *ctx);
